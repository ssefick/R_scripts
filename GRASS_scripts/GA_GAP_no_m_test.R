GAP_LULC_summary_no_m_check <- function(basin_map, LULC_data){
require(spgrass6)
...
x <- execGRASS("r.stats", flags=c("a", "N"), input=input, intern=TRUE)
...
#example fort gordon mapset
#GAP_LULC_summary_no_m_check("fgor_final_basins@PERMANENT", "gaplndcov_GA@fgo_10m_DEM")
